...
var _reactLazyContent = require('react-lazy-content');

var _reactLazyContent2 = _interopRequireDefault(_reactLazyContent);
...
var ComponentWithLazy = _react2['default'].createClass({
  displayName: 'ComponentWithLazy',

  mixins: [_reactLazyContent2['default']],
  ...
  commitsAPI: function commitsAPI(success) {
    _jquery2['default'].get(endpoint, success);
  }
});

_react2['default'].render(_react2['default'].createElement(ComponentWithLazy, null), document.getElementById('app'));

},{"jquery":3,"react":162,"react-lazy-content":4}],2:[function(require,module,exports){
...
module.exports = require('./react-lazy-content')

},{"./react-lazy-content":6,"./vendor/jquery.lazy_content":7}],5:[function(require,module,exports){
